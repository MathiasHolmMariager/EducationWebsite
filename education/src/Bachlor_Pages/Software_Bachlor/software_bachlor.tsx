...
import "./software_bachlor.css";
import dropdownContent from "./Dictionaries/SoftwareBach";
import { User, getAuth, onAuthStateChanged } from "firebase/auth";
import { get, getDatabase, ref, remove, set } from "firebase/database";
import Chatbox from "../../Components/ChatBox/chatbox";

function SoftwareBachlor() {
  ...
  useEffect(() => {
    const pairToSave = { title: "Software, Bachlor", code: "Software, Bachlor" };
    ...
    localStorage.setItem("PAGE_ID", "Software, Bachlor");
  }, []);
  //#####################LAST_SEEN_STUDY_PROGRAMS############################
  ...
  return (
    <div className="container">
      <div className="header">
        <h1>Software - Aalborg - Bachelor</h1>
        <img
...
export default SoftwareBachlor;