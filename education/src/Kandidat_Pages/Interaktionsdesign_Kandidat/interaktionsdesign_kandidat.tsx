    ...
    <div className="container">
      ...
      <div >
        ...
        <div className="text" style={{display:"flex", flexDirection:"row", height:"100%"}}>
          <div style={{width:"60%"}}>
          {accesStatus === "true" && <div style={{marginTop:"0%",marginBottom:"7%", display: "flex", alignItems:"center"}}><img src={checkIcon} style={{width:"4%", marginRight:"1%"}}/><p >  Du opfylder alle krav til denne uddannelse </p></div>}
          {accesStatus === "false" && <div style={{marginTop:"0%",marginBottom:"7%", display: "flex", alignItems:"center"}}><img src={redExIcon} style={{width:"4%", marginRight:"1%"}}/><p >  Du opfylder desværre ikke kravene til denne uddannelse </p></div>}
      ...
      <button className="dropdown-button" onClick={() => toggleDropdown(2)}>
          ...
          {dropdown2Visible && (
            <div style={{ width:"98%", margin:"auto"}}><p style={{fontSize:"20px"}}>Bacheloruddannelser der kvalificerer til optagelse</p><ul>
      ...
      <button className="dropdown-button" onClick={() => toggleDropdown(6)}>
          ...
          {dropdown6Visible && (
            <div style={{ width:"98%", margin:"auto"}}><p style={{fontSize:"20px"}}>Nogle af de mulige fremtidige jobs er:</p><ul>
          ...
          {dropdown7Visible && (
            <div className="dropdown-content">
              <div style={{ pointerEvents: 'none' }}>
                ...
                >
                  <h4 style={{ margin: "auto" }}>Løn efter dimission:</h4>
                  <h4 style={{ margin: "auto" }}>Løn efter 10 år:</h4>
                </div>
                <div
                  style={{
                    fontSize:"18px",
