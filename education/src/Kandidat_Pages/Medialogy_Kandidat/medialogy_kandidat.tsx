      ...
      get(child(diplomaRef, "bachelorTitel")).then((snapshot) => {
        if (snapshot.exists()) {
          ...
          if (value) {
            ...
            const Exist = adgangskravSubjects.some(
              (subject) => value === subject.bachelor
            );
            ...
            <div style={{ width: "60%" }}>
              {accesStatus === "true" && (
                ...
                >
                  ...
                  />
                  <p> You meet all requirements for this education </p>
                </div>
              )}
              {accesStatus === "false" && (
                <div
                ...
                >
                  ...
                  <p>
                    {" "}
                    Unfortunately, you do not meet any of the requirements for
                    this education{" "}
                  </p>
                </div>
              )}
      ...
      <div className="dropdowns">
                ...
                {dropdownContent.Adgangskrav.map((subject, index) => (
                  ...
                  >
                    ...
                    >
                      <li
                        key={index}
                        style={{ marginLeft: "1%", fontSize: "20px" }}
                      >
        ...
        >
          ...
          {dropdown6Visible && (
            <div style={{ width: "98%", margin: "auto" }}>
              <p style={{ fontSize: "20px" }}>
                Some of the possible future jobs are:
              </p>
              <ul>
        ...
        >
          ...
          {dropdown9Visible && (
            <div className="dropdown-content">
              <div>
                <p>
                  Unemployment rate among recent graduated students from the
                  study program
                </p>
                <progress
                  className="progress-bar"
