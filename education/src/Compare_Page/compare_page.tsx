  ...
  return (
    <div style={{width:"90%",height:"100%", margin:"auto", display:"flex", flexDirection:"row", overflowY:"auto"}}>
      <div style={{width:"25%", height:"100%", display:"flex", alignItems:"center", flexDirection:"column", position:"fixed"}}>
        <button style={{width:"80%", height:"7%", outline:"none", marginTop:"5%", background: underPage === '1' ? "rgb(33, 26, 82)" : "", color: underPage === '1' ? "white" : "" }} onClick={() => setUnderPage('1')}>About compare</button>
        <button style={{width:"80%", height:"7%", outline:"none", marginTop:"5%", background: underPage === '2' ? "rgb(33, 26, 82)" : "", color: underPage === '2' ? "white" : ""}} onClick={() => setUnderPage('2')}>compare 1</button>
        <button style={{width:"80%", height:"7%", outline:"none", marginTop:"5%", background: underPage === '3' ? "rgb(33, 26, 82)" : "", color: underPage === '3' ? "white" : ""}} onClick={() => setUnderPage('3')}>copare 2</button>
        <button style={{width:"80%", height:"7%", outline:"none", marginTop:"5%", background: underPage === '4' ? "rgb(33, 26, 82)" : "", color: underPage === '4' ? "white" : ""}} onClick={() => setUnderPage('4')}>compare 3</button>
      </div>
